...
public class JWTUtil
{
    ...
    public static String generateToken(String username)
    {
        try
        {
            ...
            String token = JWT.create().withIssuer("remoteFS").withSubject(username).withExpiresAt(new Date(System.currentTimeMillis() + Config.JWT_EXPIRATION_TIME_MS)).sign(algorithm);
    ...
    public static String verifyToken(String token)
    {
        ...
        try
        {
            ...
            JWTVerifier verifier = JWT.require(algorithm).withIssuer("remoteFS").build();
